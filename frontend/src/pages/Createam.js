...
function Createam() {
  ...
  if (!game) {
    return (
      ...
      >
        ...
        />
        <p style={{ marginTop: '20px', fontSize: '1.5rem' }}>Chargement...</p>
        <style>
          {`
            @keyframes spin {
  ...
  const canStart =
    game.status === "ready" && game.teams && game.teams.length === 2;
  ...
  return (
    ...
    >
      ...
      <main
        ...
        style={{ display: "flex", flex: 1, background: "#f9f9f9" }}
      >
        {/* Section Gauche (Formulaire + infos partie) */}
        <div
          className="left-section-form"
          style={{
            flex: 1,
            background: "#fff",
            padding: "40px",
        ...
        >
          ...
          {game.status !== "ongoing" && (
            <div>
              ...
              >
                ...
                >
                  <label style={{ fontWeight: "bold" }}>
                    Quel est la couleur de votre équipe ?
                  </label>
                  <div
                    ...
                    {[1, 2, 3].map((num) => (
                      <button
                        ...
                        className={`sound-button ${
                          warCry === "sound" + num ? "selected" : ""
                        }`}
                        onClick={() => {
                          canAddTeams && setWarCry("sound" + num);
                          var audio = new Audio(
                            "../../sounds/ahou-ahou-ahou.mp3"
                          );
                          audio.play();
                        }}
                        onSelect={() => {}}
                ...
                >
                  <label style={{ fontWeight: "bold" }}>
                    Quel est l'icône de votre équipe ?
                  </label>
                  <div
                    ...
                    {["🎵", "🎁", "🏆", "🐾"].map((icon) => (
                      <button
                        ...
                        style={{
                          ...
                          fontSize: "1.5rem",
                          outline:
                            teamIcon === icon ? "2px solid #000" : "none",
                        }}
                      >
                        {icon}
                      </button>
          ...
          {game.status === "waiting" && (
            <p>En attente d'au moins 2 équipes...</p>
          )}
          {canStart && (
            <button
